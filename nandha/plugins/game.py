...
TRY_LATER_IMG = "https://raw.githubusercontent.com/NandhaxD/dumps/refs/heads/main/gojo/gojo_huh.jpg"
GOOD_LUCK_IMG = "https://raw.githubusercontent.com/NandhaxD/dumps/refs/heads/main/gojo/gojo_thumbs_up.jpg"
BAD_LUCK_IMG = "https://raw.githubusercontent.com/NandhaxD/dumps/refs/heads/main/gojo/gojo_moye.jpg"
SERIOUS_IMG = "https://raw.githubusercontent.com/NandhaxD/dumps/refs/heads/main/gojo/gojo_serious.jpg"
...
async def _gamble(_, m: types.Message):
    ...
    if cash == 0:
        ...
        if user_number < 0:
            ...
            price = int(gamble * user_number)
            await update_cash(user.id, price)
            return await m.reply_text(f"🔥 Yessss, *sorcerer*! You just earned {price} Cash! You're on fire like Gojo! 💸 [\u200B]({GOOD_LUCK_IMG})")
        else:
