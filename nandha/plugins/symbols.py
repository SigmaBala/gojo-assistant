...
```
/symbols:
use this command for get your favorite symbols to use in games, names or anything you would like to use
46 symbols types available enjoy our bot! 
```
...
@bot.on_message(filters.command("symbols") & ~filters.forwarded)
